...
API_KEY_TIMEOUT = settings.api_key_timeout
...
async def get_api_key(
    ...
    if API_KEY is None:
        ...
        return True
    elif api_key_query and compare_digest(api_key_query, API_KEY):
        return api_key_query
    elif api_key_header and compare_digest(api_key_header, API_KEY):
        return api_key_header
    elif api_key_cookie and compare_digest(api_key_cookie, API_KEY):
